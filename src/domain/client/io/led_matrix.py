...
class LED_Matrix(ws.PixelStrip):
    def __init__(self, 
        ...
        super().__init__(num_cols*num_rows, pin, freq_hz, dma, invert, brightness, channel, strip_type, gamma)
    ...
    def setMatrixPixelColorRGB(self, pos : Tuple[int, int], red : int, green : int, blue : int, white=0):
